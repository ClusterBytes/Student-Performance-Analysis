...
data = pd.read_csv('/home/lince/ClusterBytes/Student-Performance-Analysis/Data preprocessing/result1.csv', index_col=0)
...
df.to_csv('MA101_a_p_mod.csv', index=False)
acc = accuracy_score(y_test, y_pred)
prec=precision_score(y_test, y_pred,average="weighted")
print('The Accuracy of MA101 is',acc)
print('The precision of  MA101 is',prec)
